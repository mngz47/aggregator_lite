...
$sql = 'INSERT INTO product (id,title,specification,quantity,brand,gender,health_table,price,date_added,company_id,discount,parameters,category,refs,shipment_cost,draft,ali_productId,ali_companyId)'.
...
$_POST['category'].'","'.(strpos($_POST['url'],'aliexpress')!=-1?'Shop On AliExpress':'Source').'>'.$_POST['url'].'|",200,0,"'.$_POST['productId'].'","'.$_POST['companyId'].'");';
