...
' VALUES ('.$newId.',"'.$_POST['heading'].'","'.$description.'",4,"'.$_POST['brand'].'",-1,-1,'.$_POST['price'].',"'.($_POST['date_added']?$_POST['date_added']:date('d-m-Y H:i')).'",'.($_POST['plug']?0:$_SESSION['company_id']).',0,"","'.
